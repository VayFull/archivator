...
{
    /// <summary>
    /// Тесты по 2 категориям:
    /// 1. сжатие файла file.txt который находится в проекте Archivator.Core, папка Data
    /// 2. прогонка алгоритмов на тестовых данных с различной длиной (в этом конкретном случае случае от 1 до 25)
    /// Соответственно суть тестов в том, что они сравнивают изначальный файл с получившимся после раскодирования.
    /// </summary>
    public class Tests
    {
